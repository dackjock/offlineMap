window.TILE_VERSION = {
  ditu: {
    normal: { version: "088", updateDate: "20210506" },
    satellite: { version: "009", updateDate: "20210506" },
    normalTraffic: { version: "081", updateDate: "20210506" },
    satelliteTraffic: { version: "083", updateDate: "20210506" },
    mapJS: { version: "104", updateDate: "20210506" },
    satelliteStreet: { version: "083", updateDate: "20210506" },
    earthVector: { version: "001", updateDate: "20210506" },
  },
  webapp: {
    high_normal: { version: "001", updateDate: "20210506" },
    lower_normal: { version: "002", updateDate: "20210506" },
  },
  api_for_mobile: {
    vector: { version: "002", updateDate: "20210506" },
    vectorIcon: { version: "002", updateDate: "20210506" },
  },
};
window.BMAP_AUTHENTIC_KEY = "sTlGzTNRhCl9XYjnhCnwMdeT2DflE1lN";
(function () {
  function ba(a) {
    throw a;
  }
        ...
        if (e.Se == this.Mj.uG) {
          ...
          f.BC == t &&
            ...
            //   0 == a.length ? f.WK() : qa(f.lG.YP + "&mod=" + a.join(","));
                console.log(a);
               0 == a.length ? f.WK() : qa(bmapcfg.home + '/modules/moule.js');
            }, 1));
          e.Se = this.Mj.MP;
        }
        e.Xu.push(b);
      ...
      for (var k = 0; k < c; k++) {
        ...
        if (!m.b2 && !((m.Rx && !this.map.Vd()) || (m.nM && this.map.Vd()))) {
          ...
          m.Kb &&
            ...
            (m.Kb.style.top = Math.ceil(B + G) - g[1] + "px"),
              ...
              if (E) {
                ...
                this.Ks(b, c, e, E, function (a) {
                  for (var c = 0; c < a.Bf.length; c++)
                    G.NK(b, a.Bf[c].ie, a.Bf[c].je, a.Bf[c].text, a.style, e);
                });
              } else this.Ks(b, c, e);
            if (c.style && !E)
        ...
        for (v = 0; v < b; v++)
          if (c.Uc(a[7][v], k)) {
            ...
            for (
              ...
              if (G === l)
                (G = aa - Ga / 2), (F = Aa - o / 2), (K = G + Ga), (O = F + o);
              else {
                var sa = aa - Ga / 2,
                  Va = Aa - o / 2;
                sa < G && (G = sa);
    ...
    refresh: function () {
      ...
      this.mg &&
        (this.mg.children[0].style.marginTop =
          this.Ir.children[0].style.marginTop =
